...
class ISCAlertSC extends WP_Widget
{
	...
	* @TODO: i18n, ugly workaround follows 
	...
	const TXTURI = 'https://isc.sans.edu/infocon.txt'; 	
	// URI for GIF image
	const IMGURI = 'https://isc.sans.edu/images/status.gif'; 
	// ...HTML (green|yellow|orange|red) + headline
	const HTMLURI= 'https://isc.sans.edu/daily_alert.html'; 
	...
	*/
	...
	public function PrintState($format)
	{
		...
		if($format=='HTML'){
			echo '<a href="https://isc.sans.org/"  style="color:'.$this->IscColor.'">'.$this->IscState.'</a>';
			return;
		}
		if($format=='SMALLIMG'){
		...
		echo '<a href="https://isc.sans.org/"><img src="'.self::IMGURI.'"'.$sizestring.' alt="Infocon Status:"'.$this->IscState.'"/></a>';
	}
